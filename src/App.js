...
function App() {
  ...
  const [projects, setProjects] = useState([
    ...
    },
    {
      ...
      nature: "individual project",
      duration: "6 days",
      info: "My user is the business ownder of a ttrpg club who needs a website to promote his business. He also needs a CRM-ish system to manage the bookings.", 
      solution: "Since his budget is low, I created a all-in-one solution; A fullstack webapp with a public space for his customers to browse about, and a private management system which only him can access by 'fake' login from where he can manage his business. Many to many db relationship used. To improve: I have found a few minor bugs I will fix at some point, I want to learn about authentication and firebase to not use fake logins, and improve CSS - this was my first ever front-end app",
  ...
  <Router>
    <Routes>
      ...
      <Route exact path='/portafolio' element={<Home/>}> </Route>
