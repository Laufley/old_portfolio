...
const Project = ({id, title, image, github_link, demo, stack, nature, duration, info, challenge, solution, features}) => {
    ...
    <>
        <li id="wrapper">
            ...
            <div id="details">
                ...
                <Link id='infoitem' to={`/Projects/${id}`} onClick={handleClick}>Click here to visit this project</Link>
                {/* <span id="info"> 
